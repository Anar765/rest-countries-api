...
const Header = () => {
    ...
    return (
        <header className={`${isDarkMode && "dark"} dark:bg-Blue-900 dark:shadow-Grey-950 bg-white shadow-Grey-400 w-full py-5 flex items-center justify-center shadow-sm`}>
            <div className="w-full max-w-400 flex items-center justify-between">
                ...
                <button onClick={() => setIsDarkMode(prevState => !prevState)} className="text-lg flex items-center gap-3">
                    {/* Icon */}
                    <IonIcon icon={isDarkMode ? sunnyOutline : moonOutline} className="w-5 h-5" />
